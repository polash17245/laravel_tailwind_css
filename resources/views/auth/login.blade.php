...
<div class="relative flex flex-col justify-center h-screen overflow-hidden">
    <div class="w-full p-6 m-auto bg-white rounded-md shadow-md ring-2 ring-gray-800/50 lg:max-w-xl">
        ...
        <form action="{{ route('login.action') }}" method="POST" class="space-y-4">
            ...
            <div>
                <button type="submit" class=" w-full input input-bordered btn btn-block">Login</button>
            </div>
{{--            <div>--}}
...
{{--            </div>--}}
            <span>Don't have an account yet?
                    <a href="{{ route('register') }}" class=" btn btn-block text-blue-600 hover:text-blue-800 hover:underline">Register</a></span>
        </form>
    </div>
</div>
</body>
